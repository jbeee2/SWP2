...
#define _DUTY_MIN 550.0 // servo full clockwise position (0 degree)
#define _DUTY_NEU 1400.0 // servo neutral position (90 degree)
#define _DUTY_MAX 2250.0 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  double dgr = 550 + ((_DUTY_MAX - _DUTY_MIN) / 180 )* (180/40 * (dist_ema - _TARGET_LOW));
  ...
  Serial.print(", dgr"); Serial.print(dgr);
  Serial.println("");
